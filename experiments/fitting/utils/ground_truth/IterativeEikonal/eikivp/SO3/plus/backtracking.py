...
import h5py
import taichi as ti
from experiments.fitting.utils.ground_truth.IterativeEikonal.eikivp.SO3.plus.interpolate import (
...
class GeodesicSO3Plus:
    ...
    def __init__(self, W: DistanceSO3Plus, target_point=None, dt=1.0):
...
class GeodesicMultiSourceSO3Plus:
    ...
    def __init__(self, W: DistanceMultiSourceSO3Plus, target_point=None, dt=1.0):
        # Vesselness attributes
        self.σ_s_list = W.σ_s_list
        self.σ_o = W.σ_o
        self.σ_s_ext = W.σ_s_ext
