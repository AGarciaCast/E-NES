...
import h5py
import taichi as ti
from experiments.fitting.utils.ground_truth.IterativeEikonal.eikivp.SO3.subRiemannian.interpolate import (
...
class GeodesicSO3SubRiemannian:
    ...
    def __init__(self, W: DistanceSO3SubRiemannian, target_point=None, dt=1.0):
    ...
    def import_γ_path(self, folder):
        ...
        with h5py.File(geodesic_filename, "r") as geodesic_file:
            assert (
                ...
                and self.ξ == geodesic_file.attrs["ξ"]
...
class GeodesicMultiSourceSO3SubRiemannian:
    ...
    def __init__(
        self, W: DistanceMultiSourceSO3SubRiemannian, target_point=None, dt=1.0
    ):
        # Vesselness attributes
        self.σ_s_list = W.σ_s_list
        self.σ_o = W.σ_o
    ...
    def compute_γ_path(
        self,
        W: DistanceMultiSourceSO3SubRiemannian,
        C: CostSO3,
        α_min,
        β_min,
        φ_min,
