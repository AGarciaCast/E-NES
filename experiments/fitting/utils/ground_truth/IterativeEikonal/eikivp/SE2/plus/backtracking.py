...
import h5py
import taichi as ti
from experiments.fitting.utils.ground_truth.IterativeEikonal.eikivp.SE2.plus.interpolate import (
...
class GeodesicSE2Plus:
    ...
    def __init__(self, W: DistanceSE2Plus, target_point=None, dt=1.0):
...
class GeodesicMultiSourceSE2Plus:
    ...
    def __init__(self, W: DistanceMultiSourceSE2Plus, target_point=None, dt=1.0):
        # Vesselness attributes
        self.σ_s_list = W.σ_s_list
        self.σ_o = W.σ_o
        self.σ_s_ext = W.σ_s_ext
